...
import DeckFlashcards from '../pages/user/DeckFlashcards';
...
import CreateDeck from '../pages/user/CreateDeck';
import DecksList from '../pages/user/DecksList';
import EditDeck from '../pages/user/EditDeck';
import StudyDeck from '../pages/user/StudyDeck';
import QuizMode from '../pages/user/QuizMode';
import QuizResults from '../pages/user/QuizResults';
import Achievements from '../pages/user/Achievements';
import ProgressStats from '../pages/user/ProgressStats';
